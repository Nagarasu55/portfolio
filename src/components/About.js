    ...
    <div className="about component__about" id="About">
      <div className="container">
        <div className="row">
          ...
          <h4 className="home__text pz__10">Hi, </h4>
          ...
          <div className="col__2">
            ...
            <div className="about__meta">
              ...
              projects on web developments and ReactJS application.I am from non IT background but i have a work
               experience in an KPO type MNC company and i am very passionate in web development so i will do the beyond best 
